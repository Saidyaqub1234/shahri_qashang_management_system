...
<div class="container">
    ...
    <div class="form-wrapper card p-4 shadow-sm">
      ...
      <!-- Image Preview -->
      <img id="preview" class="preview-image" src="https://via.placeholder.com/100" alt="Customer Image Preview" />
      ...
      <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="tel" class="form-control" name="whats_app" placeholder="Enter WhatsApp number">
        </div>
        @error('whats_app')
        <p class="text-danger">{{ $message }}</p>
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.01" class="form-control" name="dollor_amount" placeholder="USD Balance">
        </div>
        @error('dollor_amount')
        <p class="text-danger">{{ $message }}</p>
        @enderror
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.01" class="form-control" name="afghani_amount" placeholder="AFN Balance">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.01" class="form-control" name="kaldar_amount" placeholder="Kaldar Balance">
        </div>
        @error('kaldar_amount')
        <p class="text-danger">{{ $message }}</p>

    ...
    <div class="wg-box">
      <div class="row align-items-center mb-4">
        ...
        <div class="col-md-4 col-sm-8 mt-3">
          <form id="searchForm" method="GET" action="{{ route('product-type.index') }}" class="search-form d-flex">
        ...
        <div class="col-md-4 col-sm-4 mt-3 text-end">
          <a href="{{ route('product-type.create') }}" class="btn btn-success btn-sm rounded-pill">➕ Add Product</a>
        </div>
      </div>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex gap-2">
                  <a href="{{ route('product-type.show', $product->id) }}" class="text-info"><i class="fa fa-eye"></i></a>
                  <a href="{{ route('product-type.edit', $product->id) }}" class="text-warning"><i class="fa fa-edit"></i></a>
                  <a href="#" class="text-danger delete" data-id="{{ $product->id }}"><i class="fa fa-trash"></i></a>
                </div>
              </td>
            </tr>
            @endforeach

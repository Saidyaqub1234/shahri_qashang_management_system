...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <div class="input-group">
      ...
      <input type="number" class="form-control" name="item_count" id="item_count" placeholder="Enter item count" required>
    </div>
  ...
  <div class="mb-3">
    ...
    <div class="input-group">
      ...
      <input type="number" step="0.01" class="form-control" name="price" id="price" placeholder="Enter price per item" required>
    </div>
  ...
  <div class="mb-3">
    ...
    <div class="input-group">
      ...
      <input type="number" step="0.01" class="form-control" name="total_purchase_price" id="total_purchase_price" placeholder="Total price" readonly>
    </div>
    @error('total_purchase_price')<p class="text-danger">{{ $message }}</p> @enderror
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <textarea class="form-control" name="description" rows="3" placeholder="Enter container description"></textarea>
          </div>
